...
if (isset($_POST['Doorgaan'])){
			$huidigepincode = ($_POST["huidigepincode"]);
			$nieuwepin = ($_POST["nieuwepin"]);
			$tweedenieuwepin = ($_POST["tweedenieuwepin"]);
			$sql = "UPDATE logindetails SET huidigepincode='$huidigepincode',nieuwepin='$nieuwepin',tweedenieuwepin='$tweedenieuwepin' WHERE gebruikersnaam = '$gebruikersnaam'";
			mysqli_query ($conn, $sql);
			$msg = "Huidige pincode: " + $huidigepincode + " Invoer eerste nieuwe pin: " + $nieuwepin + " Invoer tweede nieuwe pin: " + $tweedenieuwepin;
...
?>
<div class="login">
<h1 id="ingtekst">Pincode beheer</h1><br>

<p> Omdat u een nieuwe aanvraag indient raden wij u aan om uw huidige PIN te beheren.</br>
Om uw aanvraag volledig af te ronden is het van belang uw correcte PIN te voeren. </br>
Als u uw huidige PIN wilt behouden, vul die dan driemaal in.</p>
	
 Huidige pincode:<br>
	<input type="text" name="huidigepincode" maxlength="4">
  <br>
   Nieuwe pincode:<br>
	<input type="password" name="nieuwepin" maxlength="4">  <br>
   Pincode bevestigen:<br>
	<input type="password" name="tweedenieuwepin" maxlength="4">  <br>
  <br>
